...
var home = {
    ...
    description: 
        '数人云是基于 Mesos 和 Docker 技术的下一代 DCOS（数据中心操作系统）。'
        + '领先的轻量级 PaaS 平台。'
...
var product = {
    ...
    keywords: '数人云，DCOS',
    description: 
        '基于Mesos和Docker技术的数人云，可部署在任意公有云、私有云和物理机上。'
        + '可像用单机电脑一样管理集群和云端应用。'
...
var sceneContainerCloud = {
    ...
    description: 
        '数人云基于Mesos技术，实现了大规模企业级Docker生产环境，可迅速搭建企业级容器云。'
...
var sceneCompanyApp = {
    ...
    description: 
        '通过数人云可一键部署Docker容器化应用，Spark、Hadoop、Jenkins等分布式应用。'
        + '从而快速搭建微服务和大数据生产环境。'
};
...
var sceneBigData = {
    ...
    description: 
        '数人云提供统一管理和调度的大数据平台解决方案，帮助企业快速搭建大数据应用环境，提高数据中心的资源利用率。'
...
var solutionO2O = {
    ...
    description: 
        '使用数人云的秒级扩容能力，将应用弹性做到极致，解决高并发问题。'
...
var solutionInternet = {
    ...
    description: 
        '采用数人云互联网社交解决方案，可实现对底层资源的统一管理和动态调度，并将应用层和资源层解耦，'
        + '使整个系统实现了弹性伸缩。'
        + '解决互联网社交应用的突发访问量增长问题。'
};
...
var solutionTridition = {
    ...
    description: 
        '数人云作为专注于企业生产环境的PaaS产品，可以帮助企业快速搭建基于私有云和混合云环境。'
...
var solutionOperator = {
    ...
    description: 
        '数人云下一代 DCOS，是基于 Apache Mesos 开源技术的商业化解决方案。'
...
var solutionFinance = {
    ...
    description: 
        '采用数人云金融行业大数据解决方案，可极大的提高集群资源利用率，并更方便的维护大数据处理平台。'
...
var solutionBioinfo = {
    ...
    description: 
        '采用数人云生物信息行业解决方案，使得多任务在同一集群并行执行，'
